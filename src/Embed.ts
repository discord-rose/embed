 ...
 * Discord Embed
 */
export class Embed <Res extends any = Promise<APIMessage>, Params extends any[] = [
  reply?: boolean,
  mention?: boolean,
  ephermal?: false
]> {
  public obj: APIEmbed = Object.assign({}, global.ROSE_DEFAULT_EMBED)
  constructor (private readonly sendback?: (embed: Embed<Res, Params>, params: Params) => Res) {}
